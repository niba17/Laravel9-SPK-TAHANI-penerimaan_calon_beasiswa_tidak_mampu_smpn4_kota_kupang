        ...
        <div class="d-flex flex-column w-100 align-items-center">
            ...
            <div class="shadow-lg rounded p-4 p-sm-5 bg-white form">
                ...
                {{-- <a href="#" class="btn btn-facebook d-block mb-2"><i
                        class="ri-facebook-circle-fill align-bottom"></i> Login
                    with Facebook</a>
                <a href="#" class="btn btn-twitter d-block mb-2"><i class="ri-twitter-fill align-bottom"></i>
                    Login with
                    Twitter</a>
                <span class="text-muted text-center d-block fw-bolder my-4">OR</span> --}}

                <!-- Register Form-->
                <form class="mt-4" action="/akun-store" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="form-label" for="password_c">Konfirmasi Password</label>
                        <input type="password" class="form-control @error('password_c') is-invalid @enderror"
                            name="password_c" id="password_c" placeholder="...">
                        @error('password_c')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary d-block w-100 my-4">Daftar Akun</button>
                </form>
                <!-- / Register Form-->
                <a href="/login" class="text-muted"><i class="fa-solid fa-angle-left"></i> Kembali
                    {{-- <a class="text-muted text-decoration-underline" href="./register.html">Sign up for an account</a> --}}
                </a>
            </div>
            <p class="d-block text-center text-muted mt-3">Sudah buat akun? <a class="text-primary" href="/login">Login
                    disini</a></p>
        </div>
        <!-- / Login Form-->

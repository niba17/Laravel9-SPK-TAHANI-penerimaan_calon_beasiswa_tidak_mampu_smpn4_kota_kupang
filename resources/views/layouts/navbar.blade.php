 ...
 <nav class="navbar navbar-expand-lg navbar-light border-bottom py-0 fixed-top bg-white">
     <div class="container-fluid">
         <a class="navbar-brand d-flex justify-content-center align-items-center border-end" href="/home">
             ...
             <div class="d-flex align-items-center">
                                     ...
                                     <li class="d-flex py-2 align-items-start">
                                         ...
                                         <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                             <div>
                                                 ...
                                                 <p class="text-muted lh-1 mb-2 small">Placed by John Doe at 11:23 AM
                                                 </p>
                                             </div>
                                             <small
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-1.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-2.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-3.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-4.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-5.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-6.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-7.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-8.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-9.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-10.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-11.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                                     ...
                                     <div class="col-4 h-100">
                                         <a href="#"
                                             ...
                                             <span class="d-block f-h-8">
                                                 <picture>
                                                     <img class="h-100"
                                                         src="{{ asset('template') }}/dist/assets/images/logos/logo-12.svg"
                                                         alt="">
                                                 </picture>
                                             </span>
                 ...
                 <div class="dropdown ms-1">
                     <button class="btn btn-link p-0 position-relative" type="button" id="profileDropdown"
                         ...
                         <picture>
                             {{-- <img class="f-w-10 rounded-circle"
                                 src="{{ asset('template') }}/dist/assets/images/profile-small.jpeg"
                     ...
                     <ul class="dropdown-menu dropdown-md dropdown-menu-end" aria-labelledby="profileDropdown">
                         ...
                         <li class="d-flex py-2 align-items-start">
                             <span
                                 class="btn-icon bg-primary-faded text-primary fw-bolder me-3">{{ Auth::user()->nama[0] }}</span>
                             <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                 <div>
                                     <p class="lh-1 mx-auto fw-semibold text-body">{{ Auth::user()->nama }}</p>
                                     <p class="lh-1 mb-0 small text-success">Administrator</p>
                                 </div>
                                 <small class="badge bg-success-faded text-success rounded-pill">online</small>
                             </div>
                         </li>
                         <li>
                             <hr class="dropdown-divider">
                         ...
                         <li><a class="dropdown-item d-flex align-items-center"
                                 href="/akun-edit/{{ Auth::user()->id }}">Edit</a>
                         </li>

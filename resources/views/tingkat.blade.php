            ...
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active"><a href="/tingkat">Tingkat & Kelas</a></li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-header justify-content-between align-items-center d-flex">
                            <h6 class="card-title m-0">Daftar Tingkat</h6>
                            <a href="/tingkat-add" type="button" class="btn btn-primary-faded btn-sm">Tambah
                                Tingkat <i class="fa-solid fa-plus"></i>
                            </a>
                            {{-- <div class="dropdown">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-header justify-content-between align-items-center d-flex">
                            ...
                            <a href="/kelas-add" type="button" class="btn btn-primary-faded btn-sm">Tambah
                                Kelas <i class="fa-solid fa-plus"></i>
                            </a>
                            {{-- <div class="dropdown">
                        <button class="btn btn-link dropdown-toggle dropdown-toggle-icon fw-bold p-0" type="button"
                            id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="text-danger"><span
                                                                class="badge rounded-pill bg-danger-faded text-danger">Tingkat
                                                                belum dipilih!</span></span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="kelas-edit/{{ $item->id }}"><i
                                                            class="fa-solid fa-pen-to-square text-primary"></i></a>
                                                    <span class="px-1 fw-bold">|</span>
                                                    <a href="#" onclick="hapus('{{ $item->id }}','kelas')"><i
                                                            class="fa-solid fa-trash text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach

...
@section('title', 'TAHANI | Ubah Data Tingkat')
@section('content')
            ...
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Tingkat</li>
                    </ol>
                </nav>
        ...
        <section class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header justify-content-between align-items-center d-flex">
                    <h6 class="card-title m-0">Edit data tingkat</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="..." value="{{ $tingkat->nama }}">
                                    @error('nama')

...
@section('title', 'TAHANI | Ubah Data Sub Kriteria')
@section('content')
    ...
    <main id="main">
        ...
        <section class="container-fluid">
            {{-- <a href="/kriteria" type="button" class="col-lg-2 col-sm-3 btn mb-2 btn-primary-faded btn-sm"><i
                    class="fa-solid fa-caret-left"></i> Kembali
            </a> --}}
            <div class="card mb-4">
                <div class="card-header justify-content-between align-items-center d-flex">
                    <h6 class="card-title m-0">Edit data Sub kriteria</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="..." value="{{ $sub_kriteria->nama }}">
                                    @error('nama')

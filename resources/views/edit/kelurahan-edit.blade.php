...
@section('title', 'TAHANI | Ubah Data Kelurahan')
@section('content')
        ...
        <section class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header justify-content-between align-items-center d-flex">
                    <h6 class="card-title m-0">Edit data Kelurahan</h6>
                </div>
                <div class="card-body">
                    <form action="/kelurahan-update/{{ $kelurahan->id }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="..." value="{{ $kelurahan->nama }}">
                                    @error('nama')
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="form-select mb-3 @error('kecamatan_id') is-invalid @enderror"

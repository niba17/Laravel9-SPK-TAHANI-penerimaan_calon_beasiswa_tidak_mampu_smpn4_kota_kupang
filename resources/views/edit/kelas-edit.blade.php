...
@section('title', 'TAHANI | Ubah Data Kelas')
@section('content')
    ...
    <main id="main">
        ...
        <section class="container-fluid">
            {{-- <a href="/tingkat" type="button" class="col-lg-2 col-sm-3 btn mb-2 btn-primary-faded btn-sm"><i
                    class="fa-solid fa-caret-left"></i> Kembali
            </a> --}}
            <div class="card mb-4">
                <div class="card-header justify-content-between align-items-center d-flex">
                    <h6 class="card-title m-0">Edit data kelas</h6>
                </div>
                <div class="card-body">
                    <form action="/kelas-update/{{ $kelas->id }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="..." value="{{ $kelas->nama }}">
                                    @error('nama')
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="form-select mb-3 @error('tingkat_id') is-invalid @enderror"
                                    aria-label=".form-select example" id="tingkat_id" name="tingkat_id">
                                    <option selected="" disabled>Pilih Kelas</option>
                                    @foreach ($tingkat as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($kelas->tingkat_id == $item->id) selected @endif>{{ $item->nama }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('tingkat_id')
                        ...
                        <a href="/tingkat" class="btn btn-outline-danger">Batal</a>
